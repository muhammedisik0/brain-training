...
class SeriallyMarkSquaresGameScreen extends GetView<SeriallyMarkSquaresGameController> {
  const SeriallyMarkSquaresGameScreen({Key? key}) : super(key: key);

  @override
  Widget build(BuildContext context) {
    return GetBuilder<SeriallyMarkSquaresGameController>(builder: (_) {
